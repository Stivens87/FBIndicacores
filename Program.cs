...
using FBindicadores;                              // El espacio de nombres raíz de nuestro proyecto
using FBindicadores.Services;                     // Contiene los servicios personalizados para comunicación con la API
...
builder.Services.AddScoped(sp => new HttpClient { 
    BaseAddress = new Uri("http://localhost:5089/api/") //modificar aquí
});
