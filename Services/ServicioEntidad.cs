...
namespace FBindicadores.Services  // Definir el espacio de nombres donde se ubicará esta clase
{
    /// <summary>
...
//         public async Task<List<Dictionary<string, object>>?> EjecutarConsultaParametrizadaAsync(
//             string nombreProyecto,
//             string nombreTabla,
//             string consultaSQL,
//             Dictionary<string, object> parametros)
...
//             try
//             {
//                 var url = $"{nombreProyecto}/{nombreTabla}/ejecutar-consulta-parametrizada";

//                 // Crear el cuerpo de la solicitud con la consulta y los parámetros
...
//                 Console.WriteLine($"Error al ejecutar consulta parametrizada: {respuesta.ReasonPhrase}");
//                 return null;
//             }
//             catch (Exception ex)
//             {
//                 Console.WriteLine($"Excepción en consulta parametrizada: {ex.Message}");
//                 return null;
//             }
//         }  
